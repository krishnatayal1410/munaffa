...
export function ProductionProfitWorkspace({ workspace }: { workspace: WorkspaceContext }) {
  ...
  return <div className="module-page interactive-workspace production-profit">
    <div className="module-heading"><CircleDollarSign size={24}/><div><span className="kicker">Recorded financials</span><h2>Contribution from entries you actually recorded.</h2><p>This view totals active revenue and expense entries for the current month. Order settlements flow into the same ledger automatically after staff records money actually received. It is an operational ledger view, not an audited profit-and-loss statement.</p></div></div>
    ...
    {canWrite && <OrderBillingPanel workspace={workspace} onLedgerChange={refresh}/>} 
